...
global.thum = fs.readFileSync("./ZeroTwoMedia/image8.jpg") //ur thumb pic
global.log0 = fs.readFileSync("./ZeroTwoMedia/image9.jpg") //ur logo pic
global.err4r = fs.readFileSync("./ZeroTwoMedia/image10.jpg") //ur error pic
global.thumb = fs.readFileSync("./ZeroTwoMedia/image10.jpg")

global.ytname = "YT: Zero Two Multi Device"
global.location = "Dressrosa , Paradise , New World"
...
//═══════[modification]════════\\
global.owner = process.env.owner || ['917012268306','919400413058'] //owner number, u can put multiple owner number, within quotations and seperated by comma.
global.pemilik = ['919400413058' , '917012268306'] //another owner number
global.premium = ['917012268306','919400413058'] //premium number
global.pengguna = 'ꜱᴏʀᴀ x ᴋᴀᴢᴇ
' //username
global.mongodb = process.env.MONGODB_URI || "Enter-MongoURI-HERE"

global.port = process.env.PORT || 5000
global.botnma = process.env.botnma || 'ꜱᴏʀᴀ x ΣΩΡΑ'//bot name
global.watermark = "If you dare step into my world again, I'll make sure you regret every breath you take."
global.botname = process.env.botnamw || 'ꜱᴏʀᴀ x ΣΩΡΑ'
global.ownernma = 'ᴋᴀᴢᴇ' //owner name
global.ownername = process.env.ownername || 'ᴋᴀᴢᴇ' //owner name
global.packname = 'ᴋᴀᴢᴇ x ꜱᴏʀᴀ' //sticker package name
global.author = 'ΣΩΡΑ' //sticker author name
global.sessionNamew = 'session.sam'
global.sessionName = process.env.SESSION_ID || 'No-Session'
global.zerotwo = "https://chat.whatsapp.com/DSrE0UiD5uGI5sRZCJyGOF" //ur gc link
global.zerotwo2 = "https://github.com/hopless-freak" //ur gc link2
